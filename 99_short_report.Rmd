...
We can also present the average difference within each matched pair. In nearly all cases, with exception of general health, the average difference increased when matching on both sets of variables. 
